// Değer döndürmeyen fonksiyonlar : işlem yapılması gereken ver herhangi bir değer döndürmeyen fonksiyonlardır.
// void fonksiyon_ismi(parametre){}

SayHello();


SayHello1("Mauro Icardi");

double alan = DaireAlan(20);
double cevre = DaireCevre(20);
Console.WriteLine(cevre);
Console.WriteLine(alan);

//DaireIslemleri();

//Console.WriteLine(BurcSonucu(19,11));
...
string BurcSonucu(int gun, int ay)
{
    ...
    else if (((gun >= 23 && ay == 10) && (gun <= 31 && ay == 10)) || ((gun >= 1 && ay == 11) && (gun <= 22 && ay == 11)))
    {
        return "Akrep";
    }
